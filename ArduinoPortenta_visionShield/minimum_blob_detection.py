# Minimum blob detection
# Source : https://docs.arduino.cc/tutorials/portenta-vision-shield/vs-openmv-bt
...
thresholds = (100, 200) # Define the min/max gray scale values we're looking for
